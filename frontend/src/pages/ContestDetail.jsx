                        ...
                        <div style={{ display: 'flex', gap: '16px', marginTop: '8px', flexWrap: 'wrap' }}>
                            {problems.length > 0 && (
                                <button
                                    ...
                                    style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '14px 32px', border: `1px solid ${C.secondary}`, color: C.primary, backgroundColor: 'transparent', fontFamily: "'JetBrains Mono', monospace", fontSize: '12px', letterSpacing: '0.1em', textTransform: 'uppercase', cursor: 'pointer', transition: 'all 0.2s' }}
